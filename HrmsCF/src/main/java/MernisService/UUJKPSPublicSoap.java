...
public class UUJKPSPublicSoap
{
    ...
    public UUJKPSPublicSoap(){}

    public UUJKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public UUJKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        UUJExtendedSoapSerializationEnvelope envelope= new UUJExtendedSoapSerializationEnvelope(UUJExtendedSoapSerializationEnvelope.VER11);
