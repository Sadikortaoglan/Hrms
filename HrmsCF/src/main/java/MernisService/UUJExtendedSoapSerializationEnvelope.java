...
public class UUJExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(UUJDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new UUJStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static UUJDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static UUJDateTimeConverter dateTimeConverter = new UUJStandardDateTimeConverter();

    public UUJExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public UUJExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new UUJMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=UUJHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,UUJExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=UUJHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
